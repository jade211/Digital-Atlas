...
//     const formattedData = formatCrimeData();

//     const chartData = {
//       labels: formattedData.map((crime) => crime.label),
//       datasets: [
//         {
//           label: 'Number of Crimes',
//           backgroundColor: 'rgba(75,192,192,0.4)',
//           borderColor: 'rgba(75,192,192,1)',
//           borderWidth: 1,
//           data: formattedData.map((crime) => crime.value),
//         },
//       ],
//     };
...
//       const formattedCrimeData = crimeTypeLabels.map((crimeTypeCode) => {
//         const crimeTypeLabel = crimeTypeLabels[crimeTypeCode];
//         return {
//           label: crimeTypeLabel,
//           value: crimeData[crimeTypeCode],
//         };
//       });
...
//       const labels = formattedData.map((entry) => entry.label);
...
//     useEffect(() => {
//       // Create a new chart when data changes
//       if (data) {
//         const ctx = chartContainer.current.getContext('2d');
  
//         const chartData = {
//           labels: formatCrimeData().map(item => item.label),
//           datasets: [
//             {
//               label: 'Crime Data',
//               backgroundColor: 'rgba(75,192,192,0.4)',
...
//               data: formatCrimeData().map(item => item.value),
//             },
//           ],
//         };
  
//         // Register the "linear" scale (you might not need this if it's registered by default)
//         Chart.controllers.bar.prototype._dataElementType = Chart.controllers.line.prototype._dataElementType;
...
//       return crimeData.map((value, index) => {
//         const crimeTypeCode = Object.keys(data.result.dimension['C02480V03003'].category.label)[index];
//         const crimeTypeLabel = crimeTypeLabels[crimeTypeCode];
//         return { label: crimeTypeLabel, value };
//       });
